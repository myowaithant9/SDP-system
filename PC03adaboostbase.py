...
def generic_clf(Y_train, X_train, Y_test, X_test, clf):
    ...
    print('PC03precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test, average=None))

    print('Accuracy for Generic PC03', accuracy_score(Y_test, pred_test))
    cm = confusion_matrix(Y_test, pred_test)
    print("\nConfusion Matrix PC03", cm)
...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        print(str(i) + 'PC03 precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test_i, average=None))

        print('PC03 Accuracy for'+ str(i) +'-->', accuracy_score(Y_test, pred_test_i))
