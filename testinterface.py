...
#    Sep 14, 2019 12:06:01 AM +0630  platform: Darwin
...
class prjInfo:
    def __init__(self, top=None):
        ...
        self.Button3.configure(command=selectData)
...
class selectData:
    def viewData(self, top=None):
        ...
        #         print('val', dataset.values[i][j])
        #         tree.insert("", 0, values= dataset.values[i][j])
        for i in range(dataset.shape[0]):
...
class outcome:
    ...
    def compare_ui(self, top=None):
        ...
        if datactrl == 5:
            tmp = "PC5 Dataset"
        modeltmp = "Methods Comparison Chart for " + tmp
        self.Label3.configure(text=modeltmp)
