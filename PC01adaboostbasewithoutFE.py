...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        print(str(i) + 'PC01 precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test_i, average=None))

        print('PC01 Accuracy for'+ str(i) +'-->', accuracy_score(Y_test, pred_test_i))
...
def concat(selected_data, target_data):
    import numpy as np
    # concat_data = np.arange(28842).reshape(759,38)
