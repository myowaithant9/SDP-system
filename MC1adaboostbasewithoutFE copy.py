...
def generic_clf(Y_train, X_train, Y_test, X_test, clf):
    ...
    print('PC02precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test, average=None))
    print('Accuracy for Generic PC02', accuracy_score(Y_test, pred_test))
...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        print('PC02 Accuracy for'+ str(i) +'-->', accuracy_score(Y_test, pred_test_i))
