...
#    Sep 15, 2019 11:01:50 PM +0630  platform: Darwin
...
def create_Toplevel1(root, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    ui3_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    def __init__(self, top=None):
        ...
        self.Label1.place(relx=0.031, rely=0.214, height=31, width=216)
        ...
        self.Label1.configure(text='''Selected features list are :''')
        ...
        self.Label4.place(relx=0.109, rely=0.311, height=31, width=96)
        self.Label4.configure(background="#a6ddf4")
        self.Label4.configure(font=font14)
        self.Label4.configure(foreground="#000000")
        self.Label4.configure(text='''1. Feature 1''')

        self.Label5 = tk.Label(self.Frame2)
        self.Label5.place(relx=0.109, rely=0.447, height=31, width=96)
        self.Label5.configure(background="#a6ddf4")
        self.Label5.configure(font=font14)
        self.Label5.configure(foreground="#000000")
        self.Label5.configure(text='''2. Feature 2''')

        self.Label6 = tk.Label(self.Frame2)
        self.Label6.place(relx=0.109, rely=0.583, height=31, width=96)
        self.Label6.configure(background="#a6ddf4")
        self.Label6.configure(font=font14)
        self.Label6.configure(foreground="#000000")
        self.Label6.configure(text='''3. Feature 3''')

        self.Label7 = tk.Label(self.Frame2)
        self.Label7.place(relx=0.109, rely=0.718, height=31, width=96)
        self.Label7.configure(background="#a6ddf4")
        self.Label7.configure(font=font14)
        self.Label7.configure(foreground="#000000")
        self.Label7.configure(text='''4. Feature 4''')

        self.Label8 = tk.Label(self.Frame2)
        self.Label8.place(relx=0.109, rely=0.854, height=31, width=96)
        self.Label8.configure(background="#a6ddf4")
        self.Label8.configure(font=font14)
        self.Label8.configure(foreground="#000000")
        self.Label8.configure(text='''5. Feature 5''')

        self.Label9 = tk.Label(self.Frame2)
        self.Label9.place(relx=0.558, rely=0.311, height=31, width=96)
        self.Label9.configure(background="#a6ddf4")
        self.Label9.configure(font=font14)
        self.Label9.configure(foreground="#000000")
        self.Label9.configure(text='''6. Feature 6''')

        self.Label10 = tk.Label(self.Frame2)
        self.Label10.place(relx=0.558, rely=0.447, height=31, width=96)
        self.Label10.configure(background="#a6ddf4")
        self.Label10.configure(font=font14)
        self.Label10.configure(foreground="#000000")
        self.Label10.configure(text='''7. Feature 7''')

        self.Label11 = tk.Label(self.Frame2)
        self.Label11.place(relx=0.558, rely=0.583, height=31, width=96)
        self.Label11.configure(background="#a6ddf4")
        self.Label11.configure(font=font14)
        self.Label11.configure(foreground="#000000")
        self.Label11.configure(text='''8. Feature 8''')

        self.Label12 = tk.Label(self.Frame2)
        self.Label12.place(relx=0.558, rely=0.718, height=31, width=96)
        self.Label12.configure(background="#a6ddf4")
        self.Label12.configure(cursor="fleur")
        self.Label12.configure(font=font14)
        self.Label12.configure(foreground="#000000")
        self.Label12.configure(text='''9. Feature 9''')

        self.Label13 = tk.Label(self.Frame2)
        self.Label13.place(relx=0.543, rely=0.854, height=31, width=117)
        self.Label13.configure(background="#a6ddf4")
        self.Label13.configure(font=font14)
        self.Label13.configure(foreground="#000000")
        self.Label13.configure(text='''10. Feature 10''')
