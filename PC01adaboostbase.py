...
def generic_clf(Y_train, X_train, Y_test, X_test, clf):
    ...
    print('precision_recall_fscore_support avg macro: {}', precision_recall_fscore_support(Y_test, pred_test, average='macro'))
    print('precision_recall_fscore_support avg micro: {}', precision_recall_fscore_support(Y_test, pred_test, average='micro'))
    print('precision_recall_fscore_support avg weighted: {}', precision_recall_fscore_support(Y_test, pred_test, average='weighted'))
    print('PC01precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test, average=None))

    print('Accuracy for GenericPC01', accuracy_score(Y_test, pred_test))
...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        # print(str(i) + 'precision_recall_fscore_support avg macro: {}', precision_recall_fscore_support(Y_test, pred_test_i, average='macro'))
        # print(str(i) + 'precision_recall_fscore_support avg micro: {}', precision_recall_fscore_support(Y_test, pred_test_i, average='micro'))
        # print(str(i) + 'precision_recall_fscore_support avg weighted: {}', precision_recall_fscore_support(Y_test, pred_test_i, average='weighted'))
        print(str(i) + 'precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test_i, average=None))

        print('Accuracy for'+ str(i) +'-->', accuracy_score(Y_test, pred_test_i))
...
if __name__ == '__main__':
    dataset_path = 'MDP csv/PC1clean.csv'
