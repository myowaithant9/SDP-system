...
class showFeature:
    ...
    #  
        ...
        # est.fit(cusdata)
        # print("est.fit", est.fit(cusdata))
        # cusdata = est.transform(cusdata).astype(int)
        # print("est.transform", est.transform(cusdata))
        ...
        # if MsgBox == 'yes':
        #     tk.messagebox.showinfo('Outcome','Your custom module have defects')
        # # root.destroy()
        # else:
        #     messagebox.showwarning('Outcome','Your custom module have classified as "Defective". Please check your code again to recover as much as possible.')
...
class outcome:
    ...
    # if modelctrl ==  2 or modelctrl == 4:
        ...
        if modelctrl == 1 or modelctrl == 2:
            ...
            pred_train, pred_test = generic_clf(Y_train, X_train, Y_test, X_test, clf_tree)
            print('custom predict', pred_test)
            if pred_test[0] == 1 :
        ...
        if modelctrl == 3 or modelctrl == 4:
            ...
            for M in x_range:  
                ...
                for i in range(M):
                    ...
                    print("predict custom data-->", pred_test_i)
