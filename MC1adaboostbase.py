...
def generic_clf(Y_train, X_train, Y_test, X_test, clf):
    ...
    print('PC02 precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test, average=None))

    print('Accuracy for PC02 Generic', accuracy_score(Y_test, pred_test))
    cm = confusion_matrix(Y_test, pred_test)
    print("\nConfusion Matrix PC02", cm)
...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        print(str(i) + 'PC02 precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test_i, average=None))

        print('Accuracy for PC02'+ str(i) +'-->', accuracy_score(Y_test, pred_test_i))
...
def concat(selected_data, target_data):
    import numpy as np
    concat_data = np.arange(17435).reshape(1585,11)
...
if __name__ == '__main__':
    ...
    dataset_path = 'MDP csv/MC1clean.csv'
