...
def generic_clf(Y_train, X_train, Y_test, X_test, clf):
    ...
    print('PC04precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test, average=None))

    print('Accuracy for Generic PC04', accuracy_score(Y_test, pred_test))
    cm = confusion_matrix(Y_test, pred_test)
    print("\nConfusion Matrix PC04", cm)
...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        print(str(i) + 'PC04 precision_recall_fscore_support avg none: {}', precision_recall_fscore_support(Y_test, pred_test_i, average=None))

        print('PC04 Accuracy for'+ str(i) +'-->', accuracy_score(Y_test, pred_test_i))
...
def concat(selected_data, target_data):
    import numpy as np
    concat_data = np.arange(16038).reshape(1458,11)
