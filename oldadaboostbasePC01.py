...
def adaboost_clf(Y_train, X_train, Y_test, X_test, M, clf):
    ...
    for i in range(M):
        ...
        # print('pred_train', np.sign(pred_train))
        # print('pred_test', pred_test)
...
if __name__ == '__main__':
    ...
    selected_data = discretize_data[:, [23,  3, 16,  9, 13,  2,  4, 10, 22,  8]]  #=> transform manual to auto
    ...
    clf_tree = SVC(kernel='rbf', random_state=0, gamma=.01, C=100000)
